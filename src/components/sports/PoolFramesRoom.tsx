...
// Legacy fallback for pool matches created before the 16-ball/8-ball ball-tracking
// engine (PoolRoom.tsx) existed - simple frame tally only, no ball-by-ball state.
// Used whenever house_rules.variant isn't '16_ball' or '8_ball'.
export default function PoolFramesRoom({ ctx }: { ctx: MatchContext }) {
